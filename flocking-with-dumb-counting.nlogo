...
turtles-own [
  ...
  local-network      ;; network of turtle's flockmates
  nearest-neighbor   ;; closest one of our flockmates
]
globals [
  flocks             ;; list of agentsets representing the flocks
  num-flocks         ;; number of flocks
  size-flocks        ;; list of sizes for the flocks
]
...
to go
  ...
  ;;   ask turtles [ fd 1 ]
  if ticks mod network-update = 0 [update-networks]
  tick
end
...
to update-networks
  clear-links
  ask turtles [create-links-with flockmates]
  set flocks nw:weak-component-clusters
  set num-flocks length flocks
  set size-flocks map count flocks
;  show size-flocks
end
...
true
false
"set-plot-pen-mode 1\nset-plot-pen-interval 1" "set-plot-x-range 0 max size-flocks\nset-plot-y-range 0 length size-flocks"
PENS
"default" 1.0 0 -16777216 true "" "histogram size-flocks"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot num-flocks"
